...
class EquipmentController < ApplicationController
  ...
  # GET /equipment/:id
  # Includes category and all maintenance records (most recent first)
  def show
    render json: {
      id:            @equipment.id,
      name:          @equipment.name,
  ...
  # DELETE /equipment/:id
  # Cascades — maintenance records are deleted automatically
  def destroy
    @equipment.destroy
    head :no_content
  end
